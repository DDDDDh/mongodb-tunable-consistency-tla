...
\@x{}%
\@y{%
 \ensuremath{LastTerm(i) \.{\defeq} LogTerm(i,\, Len(Oplog[i]))
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ RollbackAndRecover ( i ,\, j ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
\@x{\@s{16.4} \.{\land} i \.{\in} Secondary}%
\@x{\@s{16.4} \.{\land} CanRollback ( i ,\, j )}%
 \@x{\@s{16.4} \.{\land} \.{\LET} cmp \.{\defeq} RollbackCommonPoint ( i ,\, j
 )\@s{4.1} \.{\IN}}%
 \@x{\@s{31.61} \.{\LET} commonLog \.{\defeq} SubSeq ( Oplog [ i ] ,\, 1 ,\,
 cmp )}%
 \@x{\@s{52.01} appendLog\@s{6.13} \.{\defeq} SubSeq ( Oplog [ j ] ,\, cmp
 \.{+} 1 ,\, Len ( Oplog [ j ] ) )}%
 \@x{\@s{31.61} \.{\IN} Oplog \.{'} \.{=} [ Oplog {\EXCEPT} {\bang} [ i ]
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} Store \.{'} \.{=} [ Store {\EXCEPT} {\bang} [ i ]
 \.{=}\@s{4.1} Store [ j ] ]}%
 \@x{\@s{16.4} \.{\land} Ct \.{'}\@s{1.47} \.{=} [ Ct {\EXCEPT} {\bang} [ i
 ]\@s{1.47} \.{=} HLCMax ( Ct [ i ] ,\, Ct [ j ] ) ]\@s{2.94}}%
\@y{\@s{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified Sat \ensuremath{Apr} 09
 00:52:42 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
