...
\@xx{}%
 \@x{ servernodeVars \.{\defeq} {\langle} Ot ,\, SyncSource ,\, SnapshotTable
 {\rangle}\@s{77.9}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ tmessageVars \.{\defeq} {\langle} InMsgc ,\, InMsgs {\rangle}}%
 \@x{ tfunctionalVars \.{\defeq} {\langle} BlockedClient ,\, BlockedThread
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ serverVars \.{\defeq} {\langle} electionVars ,\, storageVars ,\,
 messageVar ,\, servernodeVars ,\, learnableVars ,\, timeVar ,\,
...
\@x{\@s{323.67} \.{\IN} {\lnot} HLCLt ( stateTime ,\, ot ) \}}%
 ...
 \.{\in} serverSet \.{:} Cardinality ( otherSet ) \.{<} Cardinality ( maxSet
 )}%
\@pvspace{8.0pt}%
\@x{\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\@s{31.61} \.{\land} Secondary \.{'} \.{=} Secondary \.{\cup} \{ s \}}%
 ...
 functionalVar ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 messageVar ,\, timeVar ,\, Cp ,\, State ,\, functionalVar ,\, tunableVars
 {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{32.8} \.{\land} ReadyToServe \.{'} \.{=} ReadyToServe \.{+} 1}%
 ...
 ,\, serverVars ,\, Ct ,\, messageVar ,\, timeVar ,\, Cp ,\, State ,\,
 tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvanceCp \.{\defeq}}%
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
...
\@x{\@s{71.75} \.{\IN} [ Cp {\EXCEPT} {\bang} [ s ] \.{=} newcp ]}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, serverVars ,\, timeVar ,\, functionalVar ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, serverVars ,\, learnableVars ,\, messageVar ,\, functionalVar ,\,
 tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvancePt \.{\defeq}}%
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, serverVars ,\, learnableVars ,\, functionalVar ,\, tunableVars
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{31.61} \.{\land} State \.{'} \.{=} \.{\LET} newState \.{\defeq}
 GetNewState ( i ,\, j ,\, Ot [ j ] . p ,\, Ot [ j ] . l ,\, CurrentTerm [ j
 ] )}%
 \@x{\@s{81.58} \.{\IN} [ State {\EXCEPT} {\bang} [ i ] \.{=} newState
 ]\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\@s{82.23} \.{\land} Tick ( s )\@s{4.1}}%
\@y{\@s{0}%
 advance cluster time
}%
\@xx{}%
 \@x{\@s{82.23} \.{\land} Oplog \.{'} \.{=} [ Oplog {\EXCEPT} {\bang} [ s ]
...
\@xx{}%
 \@x{\@s{82.23} \.{\land} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ]
 \.{=} Tail ( @ ) ]}%
...
\@x{\@s{69.93} \.{\land} State \.{'} \.{=} State}%
 ...
 \.{=} Tail ( @ ) ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, functionalVar
 ,\, Cp ,\, CurrentTerm ,\, messageVar ,\, SyncSource ,\, Store ,\, timeVar
 ,\,}%
...
\@x{\@s{27.51} \.{\land} BlockedThread [ c ] . type \.{=}\@w{read}}%
 \@x{\@s{27.51} \.{\land} {\IF} BlockedThread [ c ] . rc
 \.{=}\@w{linearizable}}%
 \@x{\@s{46.82} \.{\THEN} \.{\land} {\lnot} HLCLt ( Cp [ BlockedThread [ c ] .
...
\@xx{}%
 ...
 \@x{\@s{140.45} k \.{\mapsto} BlockedThread [ c ] . k ,\, v \.{\mapsto}
 BlockedThread [ c ] . v ,\,}%
 \@x{\@s{140.45} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\, ot
 \.{\mapsto} BlockedThread [ c ] . ot ] ) ]}%
 \@x{\@s{38.62} \.{\ELSE} \.{\land} {\lnot} HLCLt ( Ot [ BlockedThread [ c ] .
 s ] ,\, BlockedThread [ c ] . ot )}%
\@y{\@s{0}%
 wait until \ensuremath{Ot[s] \.{\geq}} target \ensuremath{ot
}}%
\@xx{}%
\@x{\@s{69.93} \.{\land} {\IF} BlockedThread [ c ] . rc \.{=}\@w{local}}%
 \@x{\@s{89.24} \.{\THEN} InMsgc \.{'} \.{=} [ InMsgc {\EXCEPT} {\bang} [ c ]
 \.{=} Append ( @ ,\, [ op \.{\mapsto}\@w{get} ,\, k \.{\mapsto}
 BlockedThread [ c ] . k ,\,}%
 \@x{\@s{171.76} v \.{\mapsto} Store [ BlockedThread [ c ] . s ] [
 BlockedThread [ c ] . k ] ,\,}%
 \@x{\@s{171.76} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\,
 ot\@s{20.44} \.{\mapsto} Ot [ BlockedThread [ c ] . s ] ] ) ]}%
...
\@xx{}%
 ...
 \.{=} Tail ( @ ) ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, functionalVar
 ,\, Cp ,\, CurrentTerm ,\, messageVar ,\, SyncSource ,\, timeVar ,\,}%
 \@x{\@s{89.98} InMsgc ,\, BlockedClient ,\, clientnodeVars ,\, SnapshotTable
 {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
 \@x{\@s{16.4} \.{\land} \E\, k \.{\in} Key ,\, c\@s{13.22} \.{\in} Client
 \.{\,\backslash\,} BlockedClient ,\, rConcern \.{\in} ReadConcern ,\, rp
 \.{\in} ReadPreference \.{:}}%
\@x{\@s{31.61} \.{\land} {\IF} rConcern \.{=}\@w{linearizable}}%
\@y{\@s{0}%
...
\@x{\@s{42.72} \.{\THEN} \E\, s \.{\in} Primary \.{:}}%
 ...
 \.{\mapsto} rConcern ,\, k \.{\mapsto} k ,\, ct \.{\mapsto} Ct [ c ] ,\, ot
 \.{\mapsto} Ot [ c ] ] ) ]}%
\@x{\@s{42.72} \.{\ELSE} {\IF} rp \.{=}\@w{primary}}%
\@y{\@s{0}%
 \ensuremath{rp} can be only primary or secondary
}%
\@xx{}%
...
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
 ...
 Client \.{\,\backslash\,} BlockedClient ,\, wConcern \.{\in} WriteConcern
 ,\, wNum \.{\in} WriteNumber ,\, s \.{\in} Primary \.{:}}%
\@x{\@s{31.61} \.{\land} OpCount [ c ] \.{\neq} 0}%
 \@x{\@s{31.61} \.{\land} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ]
 \.{=} Append ( @ ,\,}%
 \@x{\@s{101.88} [ op \.{\mapsto}\@w{put} ,\, c \.{\mapsto} c ,\, wc
 \.{\mapsto} wConcern ,\, num \.{\mapsto} wNum ,\, k \.{\mapsto} k ,\, v
 \.{\mapsto} v ,\, ct \.{\mapsto} Ct [ c ] ] ) ]}%
\@x{\@s{31.61} \.{\land} {\IF} wConcern \.{=}\@w{zero}}%
\@y{%
...
\@x{}%
\@y{\@s{0}%
 do we need to update \ensuremath{Ct[c]} here\.{?}
}%
\@xx{}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, functionalVar
 ,\, learnableVars ,\, messageVar ,\, servernodeVars ,\, Oplog ,\, timeVar
 ,\,}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, functionalVar
 ,\, Cp ,\, CurrentTerm ,\, State ,\, messageVar ,\, SyncSource ,\,
 storageVars ,\, timeVar ,\,}%
\@x{\@s{89.98} BlockedThread ,\, InMsgs ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Tue} May 17
 17:12:38 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
