...
\@xx{}%
\@x{ {\CONSTANTS} Client ,\, Server ,\,\@s{29.50}}%
\@y{\@s{0}%
 the set of clients and servers
}%
\@xx{}%
\@x{\@s{54.75} Key ,\, Value ,\,\@s{42.62}}%
\@y{\@s{0}%
 the set of keys and values
}%
\@xx{}%
\@x{\@s{54.75} Nil ,\,\@s{77.72}}%
\@y{\@s{0}%
 model value, place holder
}%
\@xx{}%
\@x{\@s{54.75} OpTimes ,\,\@s{51.13}}%
\@y{\@s{0}%
 \ensuremath{op} count at most
}%
\@xx{}%
\@x{\@s{54.75} PtStop ,\,\@s{61.91}}%
\@y{\@s{0}%
 max physical time
}%
\@xx{}%
\@x{\@s{54.75} WriteNumber ,\,\@s{31.66}}%
\@y{\@s{0}%
 Para: \ensuremath{writeConcern} number \ensuremath{\.{\rightarrow}} should
 be set even when w:maj
}%
\@xx{}%
\@x{\@s{54.75} ReadConcern ,\,\@s{33.53}}%
\@y{\@s{0}%
 Para: read concern
}%
\@xx{}%
\@x{\@s{54.75} ReadPreference ,\,\@s{24.60}}%
\@y{\@s{0}%
 Para: read preference
}%
\@xx{}%
\@x{\@s{54.75} WriteConcern\@s{35.55}}%
\@y{\@s{0}%
 Para: write concern
}%
\@xx{}%
...
\@x{\@s{51.42}}%
\@y{\@s{0}%
 Following are the Tunable related \ensuremath{vars
}}%
\@xx{}%
...
\@xx{}%
\@x{\@s{51.42} SnapshotTable\@s{11.01}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ storageVars \.{\defeq} {\langle} Oplog ,\, Store {\rangle}\@s{89.22}}%
\@y{\@s{0}%
 \ensuremath{vars} that are related to storage
}%
\@xx{}%
\@x{ messageVar \.{\defeq} {\langle} ServerMsg {\rangle}\@s{96.57}}%
\@y{\@s{0}%
 var that is related to message
}%
\@xx{}%
 \@x{ servernodeVars \.{\defeq} {\langle} Ot ,\, SyncSource
 {\rangle}\@s{77.9}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ clientnodeVars \.{\defeq} {\langle} History ,\, OpCount {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ serverVars \.{\defeq} {\langle} electionVars ,\, storageVars ,\,
 messageVar ,\, servernodeVars ,\, learnableVars ,\, timeVar {\rangle}}%
 \@x{ tunableVars \.{\defeq} {\langle} BlockedClient ,\, BlockedThread ,\,
 History ,\, InMsgc ,\, InMsgs ,\, OpCount ,\, SnapshotTable {\rangle}}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
 \@x{ {\ASSUME} ReadConcern \.{\in} \{\@w{local} ,\,\@w{majority}
 ,\,\@w{linearizable} \}}%
 \@x{ {\ASSUME} WriteConcern \.{\in} \{\@w{zero} ,\,\@w{num} ,\,\@w{majority}
 \}}%
\@x{ {\ASSUME} ReadPreference \.{\in} \{\@w{primary} ,\,\@w{secondary} \}}%
\@x{ {\ASSUME} WriteNumber \.{\leq} Cardinality ( Server )}%
\@y{\@s{0}%
 w:\ensuremath{num} cannot be greater than server number
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{}%
...
\@xx{}%
\@x{ HLCLt ( x ,\, y ) \.{\defeq} {\IF} x . p \.{<} y . p \.{\THEN} {\TRUE}}%
 \@x{\@s{75.76} \.{\ELSE} {\IF} x . p \.{=} y . p \.{\THEN} {\IF} x . l \.{<}
 y . l \.{\THEN} {\TRUE}}%
\@x{\@s{192.49} \.{\ELSE} {\FALSE}}%
...
\@x{\@s{41.61} OpCount ,\, Pt ,\, Cp ,\, State ,\, SnapshotTable ,\,}%
\@x{\@s{41.61} History ,\, CurrentTerm ,\, SyncSource {\rangle}}%
\@x{}%
\@y{\@s{0}%
 snapshot helpers
}%
...
\@x{ LastTerm ( i ) \.{\defeq} CurrentTerm [ i ]\@s{4.1}}%
\@y{%
...
\@pvspace{8.0pt}%
 ...
 Pt [ s ] ,\, l \.{\mapsto} 0 ] ]}%
\@x{ UpdateAndTick ( s ,\, msgCt ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} newCt \.{\defeq} [ Ct {\EXCEPT} {\bang} [ s ] \.{=}
 HLCMax ( Ct [ s ] ,\, msgCt ) ]}%
\@y{\@s{0}%
 Update \ensuremath{ct} first according to \ensuremath{msg
}}%
\@xx{}%
 \@x{\@s{16.4} \.{\IN} Ct \.{'} \.{=} {\IF} newCt [ s ] . p \.{\geq} Pt [ s ]
 \.{\THEN} [ newCt {\EXCEPT} {\bang} [ s ] \.{=} [ p \.{\mapsto} @ . p ,\, l
 \.{\mapsto} @ . l \.{+} 1 ] ]}%
 \@x{\@s{158.65} \.{\ELSE} [ newCt {\EXCEPT} {\bang} [ s ] \.{=} [ p
 \.{\mapsto} Pt [ s ] ,\, l \.{\mapsto} 0 ] ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{heartbeat \.{-}} Only \ensuremath{Primary} node sends heartbeat
 once advance pt
}%
\@xx{}%
...
\@x{\@s{96.25} \.{\land} CurrentTerm [ i ] \.{<} CurrentTerm [ j ]}%
 \@x{\@s{96.25} \.{\land} \.{\lor} Len ( Oplog [ i ] ) \.{>} Len ( Oplog [ j ]
 )}%
 \@x{\@s{107.36} \.{\lor} \.{\land} Len ( Oplog [ i ] ) \.{\leq} Len ( Oplog [
 j ] )}%
 \@x{\@s{118.48} \.{\land} CurrentTerm [ i ] \.{\neq} LogTerm ( j ,\, Len (
 Oplog [ i ] ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{\@s{16.4} \.{\IN} quorums}%
\@pvspace{8.0pt}%
\@x{ ReplicatedServers ( states ,\, ot ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} serverSet \.{\defeq} \{ subServers \.{\in} {\SUBSET} (
 Server ) \.{:} \A\, s \.{\in} subServers \.{:} \.{\LET} stateTime \.{\defeq}
 [ p \.{\mapsto} states [ s ] . p ,\, l \.{\mapsto} states [ s ] . l ]}%
\@x{\@s{323.67} \.{\IN} {\lnot} HLCLt ( stateTime ,\, ot ) \}}%
 \@x{\@s{16.4} \.{\IN} {\CHOOSE} maxSet \.{\in} serverSet \.{:} \A\, otherSet
 \.{\in} serverSet \.{:} Cardinality ( otherSet ) \.{\leq} Cardinality (
 maxSet )}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\IN} {\IF}} \ensuremath{Cardinality(serverSet) \.{=} 0}
 \ensuremath{\.{\THEN} \{\}
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\ELSE} {\IF}} \ensuremath{Cardinality(serverSet) \.{=} 1}
 \ensuremath{\.{\THEN} serverSet
}}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
 \ensuremath{\.{\ELSE} {\CHOOSE} maxSet \.{\in} serverSet}: \ensuremath{\A\,
 otherSet \.{\in} serverSet}: \ensuremath{Cardinality(otherSet) \.{\leq}
 Cardinality(maxSet)
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{4.1}}%
\@y{\@s{0}%
 Compute a new common point according to new update position \ensuremath{msg
}}%
\@xx{}%
\@x{ ComputeNewCp ( s ) \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 primary node: compute new mcp
}%
\@xx{}%
\@x{\@s{16.4} {\IF} s \.{\in} Primary \.{\THEN}}%
 \@x{\@s{32.65} \.{\LET} quorumAgree \.{\defeq} QuorumAgreeInSameTerm ( State
 [ s ] ) \.{\IN}}%
\@x{\@s{32.65} {\IF}\@s{4.1} Cardinality ( quorumAgree ) \.{>} 0}%
 \@x{\@s{48.91} \.{\THEN} \.{\LET} QuorumSet \.{\defeq} {\CHOOSE} i \.{\in}
 quorumAgree \.{:} {\TRUE}}%
 \@x{\@s{100.62} serverInQuorum \.{\defeq} {\CHOOSE} j \.{\in} QuorumSet \.{:}
 {\TRUE}}%
 \@x{\@s{100.62} termOfQuorum \.{\defeq} State [ s ] [ serverInQuorum ] .
 term}%
\@y{\@s{0}%
 never commit log entries from previous terms
}%
\@xx{}%
 \@x{\@s{100.62} StateSet \.{\defeq} \{ [ p \.{\mapsto} State [ s ] [ j ] . p
 ,\, l \.{\mapsto} State [ s ] [ j ] . l ] \.{:} j \.{\in} QuorumSet \}}%
\@x{\@s{104.72} newCommitPoint \.{\defeq} HLCMinSet ( StateSet )}%
\@x{\@s{80.22} \.{\IN}\@s{4.09} {\IF} termOfQuorum \.{=} CurrentTerm [ s ]}%
 \@x{\@s{116.87} \.{\THEN} [ p \.{\mapsto} newCommitPoint . p ,\, l
 \.{\mapsto} newCommitPoint . l ,\, term \.{\mapsto} termOfQuorum ]}%
\@x{\@s{104.72} \.{\ELSE} Cp [ s ]}%
\@x{\@s{40.85} \.{\ELSE} Cp [ s ]}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} \.{\ELSE} {\IF} Len ( ServerMsg [ s ] ) \.{\neq} 0 \.{\THEN}}%
 \@x{\@s{59.86} \.{\LET} msgCP \.{\defeq} [ p \.{\mapsto} ServerMsg [ s ] [ 1
 ] . cp . p ,\, l \.{\mapsto} ServerMsg [ s ] [ 1 ] . cp . l ] \.{\IN}}%
\@x{\@s{59.86} {\IF} \.{\land} {\lnot} HLCLt ( msgCP ,\, Cp [ s ] )}%
\@x{\@s{72.02} \.{\land} {\lnot} HLCLt ( Ot [ s ] ,\, msgCP )}%
\@x{\@s{72.02}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{72.02} \.{\land} ServerMsg [ s ] [ 1 ] . term \.{=} CurrentTerm [ s
 ]}%
\@x{\@s{72.02} \.{\THEN} ServerMsg [ s ] [ 1 ] . cp}%
\@x{\@s{59.86} \.{\ELSE} Cp [ s ]}%
\@x{\@s{47.71} \.{\ELSE} Cp [ s ]}%
\@pvspace{8.0pt}%
\@x{ GetNewState ( s ,\, d ,\, np ,\, nl ,\, nterm ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} newSubState \.{\defeq} [ p \.{\mapsto} np ,\, l
 \.{\mapsto} nl ,\, term \.{\mapsto} nterm ]}%
\@x{\@s{40.89} sState \.{\defeq} State [ s ]}%
 \@x{\@s{16.4} \.{\IN}\@s{4.09} [ sState {\EXCEPT} {\bang} [ d ] \.{=}
 newSubState ]}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{}%
...
\@xx{}%
 ...
 [ s0 \.{\in} Server \.{\mapsto}}%
 \@x{\@s{178.67} [ p \.{\mapsto} 0 ,\, l \.{\mapsto} 0 ,\, term\@s{3.97}
 \.{\mapsto} 0 ] ] ]}%
 ...
 {\langle} {\rangle} ]\@s{4.1}}%
\@y{\@s{0}%
 History operation seq is empty
}%
\@xx{}%
 \@x{ InitCurrentTerm \.{\defeq} CurrentTerm \.{=} [ p \.{\in} Primary
 \.{\mapsto} 1 ] \.{\,@@\,} [ s \.{\in} Server \.{\mapsto} 0 ]}%
...
\@x{ Init \.{\defeq}}%
 ...
 \.{\land} InitCurrentTerm\@s{7.24} \.{\land} InitSyncSource}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, InMsgc ,\,
 InMsgs ,\, BlockedClient ,\, BlockedThread ,\, OpCount ,\, History
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Stepdown \.{\defeq}}%
...
\@x{\@s{31.61} \.{\land} Secondary \.{'} \.{=} Secondary \.{\cup} \{ s \}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} storageVars ,\, servernodeVars
...
\@xx{}%
 ...
 messageVar ,\, timeVar ,\, Cp ,\, State ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvanceCp \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Primary \.{:}}%
\@x{\@s{31.61} \.{\LET} newCp \.{\defeq} ComputeNewCp ( s )}%
 \@x{\@s{31.61} \.{\IN} Cp \.{'} \.{=} [ Cp {\EXCEPT} {\bang} [ s ] \.{=}
 newCp ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, servernodeVars ,\, Ct ,\, messageVar ,\, timeVar ,\, State ,\,
 CurrentTerm ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
...
\@x{\@s{31.61} \.{\land} ServerMsg [ s ] [ 1 ] . type \.{=}\@w{heartbeat}}%
 ...
 term}%
\@y{\@s{0}%
 only consider heartbeat \ensuremath{msg} in same term
}%
\@xx{}%
 \@x{\@s{31.61} \.{\land} Ct \.{'} \.{=} [ Ct {\EXCEPT} {\bang} [ s ] \.{=}
 HLCMax ( Ct [ s ] ,\, ServerMsg [ s ] [ 1 ] . ct ) ]}%
 \@x{\@s{31.61} \.{\land} State \.{'} \.{=} \.{\LET} newState \.{\defeq}
 GetNewState ( s ,\, ServerMsg [ s ] [ 1 ] . s ,\, ServerMsg [ s ] [ 1 ] .
 aot . p ,\, ServerMsg [ s ] [ 1 ] . aot . l ,\, ServerMsg [ s ] [ 1 ] . term
 )}%
\@x{\@s{81.58} \.{\IN} [ State {\EXCEPT} {\bang} [ s ] \.{=} newState ]}%
...
\@x{}%
\@y{\@s{15.0}%
 \ensuremath{\.{\land} CurrentTerm\.{'} \.{=}} [\ensuremath{CurrentTerm}
 \ensuremath{{\EXCEPT} {\bang}[s] \.{=} Max(CurrentTerm[s],\,
 ServerMsg[s][1].term)}] \ensuremath{\.{\rightarrow}}因为之前的判断，根本不会触发
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, servernodeVars ,\, timeVar ,\, CurrentTerm ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{149.73} \.{\IN} newMsg ) )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, servernodeVars ,\, timeVar ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NTPSync \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, servernodeVars ,\, learnableVars ,\, messageVar ,\, tunableVars
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvancePt \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Server \.{:}}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, servernodeVars ,\, learnableVars ,\, tunableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Replication
...
\@x{\@s{31.61} \.{\land} State \.{'} \.{=}}%
 \@x{\@s{46.82} \.{\LET} newStatei\@s{0.42} \.{\defeq} [ p \.{\mapsto} Ot
 \.{'} [ i ] . p ,\, l \.{\mapsto} Ot \.{'} [ i ] . l ,\, term \.{\mapsto}
 CurrentTerm \.{'} [ i ] ]}%
 \@x{\@s{67.22} newStatej \.{\defeq} [ p \.{\mapsto} Ot [ j ] . p ,\, l
 \.{\mapsto} Ot [ j ] . l ,\, term \.{\mapsto} CurrentTerm [ j ] ]}%
...
\@xx{}%
\@x{ ServerGetReply\_sleep \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Server \.{:}}%
\@x{\@s{27.51} \.{\land} Len ( InMsgs [ s ] ) \.{\neq} 0}%
\@x{\@s{27.51} \.{\land} InMsgs [ s ] [ 1 ] . op \.{=}\@w{get}}%
 \@x{\@s{27.51} \.{\land} {\IF} InMsgs [ s ] [ 1 ] . rc
 \.{=}\@w{linearizable}}%
\@x{\@s{46.82} \.{\THEN}\@s{4.1} \.{\land} s \.{\in} Primary}%
 \@x{\@s{82.23} \.{\land} UpdateAndTick ( s ,\, InMsgs [ s ] [ 1 ] . ct
 )\@s{4.1}}%
\@y{\@s{0}%
 advance cluster time
}%
\@xx{}%
 \@x{\@s{82.23} \.{\land} Oplog \.{'} \.{=} \.{\LET} entry \.{\defeq} [ k
 \.{\mapsto} Nil ,\, v \.{\mapsto} Nil ,\, ot \.{\mapsto} Ct \.{'} [ s ] ,\,
 term \.{\mapsto} CurrentTerm [ s ] ]}%
\@x{\@s{159.40} newLog \.{\defeq} Append ( Oplog [ s ] ,\, entry )}%
 \@x{\@s{134.90} \.{\IN}\@s{4.10} [ Oplog {\EXCEPT} {\bang} [ s ] \.{=} newLog
 ]}%
\@x{\@s{90.43}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{82.23} \.{\land} Ot \.{'} \.{=} [ Ot {\EXCEPT} {\bang} [ s ]
 \.{=}\@s{4.1} Ct \.{'} [ s ] ]}%
\@x{\@s{90.43}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{82.23} \.{\land} State \.{'} \.{=} \.{\LET} newState \.{\defeq}
 GetNewState ( s ,\, s ,\, Ot \.{'} [ s ] . p ,\, Ot \.{'} [ s ] . l ,\,
 CurrentTerm [ s ] )}%
 \@x{\@s{132.21} \.{\IN} [ State {\EXCEPT} {\bang} [ s ] \.{=} newState
 ]\@s{20.5}}%
\@y{\@s{0}%
 update primary state
}%
\@xx{}%
 \@x{\@s{82.23} \.{\land} BlockedThread \.{'} \.{=} [ BlockedThread {\EXCEPT}
 {\bang} [ InMsgs [ s ] [ 1 ] . c ] \.{=}}%
 \@x{\@s{176.17} [ type \.{\mapsto}\@w{read} ,\, rc \.{\mapsto} InMsgs [ s ] [
 1 ] . rc ,\, ot \.{\mapsto} Ct \.{'} [ s ] ,\, s \.{\mapsto} s ,\,}%
 \@x{\@s{176.17} k \.{\mapsto} InMsgs [ s ] [ 1 ] . k ,\, v \.{\mapsto} Store
 [ s ] [ InMsgs [ s ] [ 1 ] . k ] ] ]}%
\@x{\@s{93.34}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{38.62} \.{\ELSE} \.{\land} Ct \.{'} \.{=} [ Ct {\EXCEPT} {\bang} [ s
 ] \.{=} HLCMax ( Ct [ s ] ,\, InMsgs [ s ] [ 1 ] . ct ) ]}%
\@y{%
 \ensuremath{rc \.{=} local} or major
}%
\@xx{}%
 \@x{\@s{69.93} \.{\land} BlockedThread \.{'} \.{=} [ BlockedThread {\EXCEPT}
 {\bang} [ InMsgs [ s ] [ 1 ] . c ] \.{=}}%
 \@x{\@s{122.04} [ type \.{\mapsto}\@w{read} ,\, rc \.{\mapsto} InMsgs [ s ] [
 1 ] . rc ,\, s \.{\mapsto} s ,\, k \.{\mapsto} InMsgs [ s ] [ 1 ] . k ,\, ot
 \.{\mapsto} InMsgs [ s ] [ 1 ] . ot ] ]}%
\@x{\@s{69.93} \.{\land} Oplog \.{'} \.{=} Oplog}%
\@x{\@s{69.93} \.{\land} Ot \.{'} \.{=} Ot}%
\@x{\@s{69.93} \.{\land} State \.{'} \.{=} State}%
 \@x{\@s{27.51} \.{\land} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ]
 \.{=} Tail ( @ ) ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, Cp ,\,
 CurrentTerm ,\, messageVar ,\, SyncSource ,\, Store ,\, timeVar ,\,}%
 \@x{\@s{89.98} InMsgc ,\, BlockedClient ,\, clientnodeVars ,\, SnapshotTable
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ServerGetReply\_wake \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, c \.{\in} Client \.{:}}%
\@x{\@s{27.51} \.{\land} BlockedThread [ c ] \.{\neq} Nil}%
\@x{\@s{27.51} \.{\land} BlockedThread [ c ] . type \.{=}\@w{read}}%
\@x{\@s{27.51} \.{\land} {\IF} BlockedThread [ c ] . rc \.{=}\@w{local}}%
 \@x{\@s{46.82} \.{\THEN} \.{\land} {\lnot} HLCLt ( Ot [ BlockedThread [ c ] .
 s ] ,\, BlockedThread [ c ] . ot )}%
\@y{\@s{0}%
 wait until \ensuremath{Ot[s] \.{\geq}} target \ensuremath{ot
}}%
\@xx{}%
 \@x{\@s{78.13} \.{\land} InMsgc \.{'} \.{=} [ InMsgc {\EXCEPT} {\bang} [ c ]
 \.{=} Append ( @ ,\, [ op \.{\mapsto}\@w{get} ,\, k \.{\mapsto}
 BlockedThread [ c ] . k ,\,}%
 \@x{\@s{160.95} v \.{\mapsto} Store [ BlockedThread [ c ] . s ] [
 BlockedThread [ c ] . k ] ,\,}%
 \@x{\@s{160.95} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\, ot
 \.{\mapsto} Ot [ BlockedThread [ c ] . s ] ] ) ]}%
 \@x{\@s{38.62} \.{\ELSE} \.{\land} {\lnot} HLCLt ( Cp [ BlockedThread [ c ] .
 s ] ,\, BlockedThread [ c ] . ot )}%
\@y{\@s{0}%
 wait until \ensuremath{cp[s] \.{\geq}} target \ensuremath{ot
}}%
\@xx{}%
 \@x{\@s{69.93} \.{\land} {\IF} BlockedThread [ c ] . rc
 \.{=}\@w{linearizable}}%
 \@x{\@s{89.24} \.{\THEN} InMsgc \.{'} \.{=} [ InMsgc {\EXCEPT} {\bang} [ c ]
 \.{=} Append ( @ ,\, [ op \.{\mapsto}\@w{get} ,\,}%
 \@x{\@s{156.95} k \.{\mapsto} BlockedThread [ c ] . k ,\, v \.{\mapsto}
 BlockedThread [ c ] . v ,\,}%
 \@x{\@s{156.95} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\, ot
 \.{\mapsto} BlockedThread [ c ] . ot ] ) ]}%
 \@x{\@s{81.04} \.{\ELSE} InMsgc \.{'} \.{=} [ InMsgc {\EXCEPT} {\bang} [ c ]
 \.{=} Append ( @ ,\, [ op \.{\mapsto}\@w{get} ,\, k \.{\mapsto}
 BlockedThread [ c ] . k ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{rc \.{=} majority
}}%
\@xx{}%
 \@x{\@s{163.56} v \.{\mapsto} SelectSnapshot ( SnapshotTable [ BlockedThread
 [ c ] . s ] ,\, Cp [ BlockedThread [ c ] . s ] ) [ BlockedThread [ c ] . k ]
 ,\,}%
 \@x{\@s{163.56} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\, ot
 \.{\mapsto} Cp [ BlockedThread [ c ] . s ] ] ) ]}%
 \@x{\@s{27.51} \.{\land} BlockedThread \.{'} \.{=} [ BlockedThread {\EXCEPT}
 {\bang} [ c ] \.{=} Nil ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, clientnodeVars
 ,\, BlockedClient ,\, InMsgs ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ServerPutReply\_sleep \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Primary \.{:}}%
\@x{\@s{31.61} \.{\land} Len ( InMsgs [ s ] ) \.{\neq} 0}%
\@x{\@s{31.61} \.{\land} InMsgs [ s ] [ 1 ] . op \.{=}\@w{put}}%
\@x{\@s{31.61} \.{\land} UpdateAndTick ( s ,\, InMsgs [ s ] [ 1 ] . ct )}%
...
\@y{\@s{0}%
 append operation to \ensuremath{oplog[s]
}}%
\@xx{}%
...
\@x{\@s{84.27} \.{\IN} [ Oplog {\EXCEPT} {\bang} [ s ] \.{=} newLog ]}%
 \@x{\@s{31.61} \.{\land} State \.{'}\@s{2.68} \.{=} \.{\LET} newState
 \.{\defeq} GetNewState ( s ,\, s ,\, Ot \.{'} [ s ] . p ,\, Ot \.{'} [ s ] .
 l ,\, CurrentTerm [ s ] )}%
 \@x{\@s{84.27} \.{\IN} [ State {\EXCEPT} {\bang} [ s ] \.{=} newState
 ]\@s{20.5}}%
\@y{\@s{0}%
 update primary state
}%
\@xx{}%
\@x{\@s{31.61} \.{\land} {\IF} InMsgs [ s ] [ 1 ] . wc \.{=}\@w{zero}}%
\@y{\@s{0}%
 If w:0, do not sleep
}%
\@xx{}%
\@x{\@s{46.82} \.{\THEN} BlockedThread \.{'} \.{=} BlockedThread}%
 \@x{\@s{42.72} \.{\ELSE} BlockedThread \.{'} \.{=} [ BlockedThread {\EXCEPT}
 {\bang} [ InMsgs [ s ] [ 1 ] . c ] \.{=} [ type \.{\mapsto}\@w{write} ,\, wc
 \.{\mapsto} InMsgs [ s ] [ 1 ] . wc ,\,}%
 \@x{\@s{160.96} numnode \.{\mapsto} InMsgs [ s ] [ 1 ] . num ,\, ot
 \.{\mapsto} Ot \.{'} [ s ] ,\, s \.{\mapsto} s ,\,}%
 \@x{\@s{160.96} k \.{\mapsto} InMsgs [ s ] [ 1 ] . k ,\, v \.{\mapsto} InMsgs
 [ s ] [ 1 ] . v ] ]}%
\@y{\@s{0}%
 add the user \ensuremath{History} to \ensuremath{BlockedThread[c]
}}%
\@xx{}%
 \@x{\@s{31.61} \.{\land} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ]
 \.{=} Tail ( @ ) ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, Cp ,\,
 CurrentTerm ,\, messageVar ,\, SyncSource ,\, timeVar ,\,}%
 \@x{\@s{89.98} InMsgc ,\, BlockedClient ,\, clientnodeVars ,\, SnapshotTable
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ServerPutReply\_wake \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, c \.{\in} Client \.{:}}%
\@x{\@s{31.61} \.{\land} BlockedThread [ c ] \.{\neq}\@s{4.1} Nil}%
\@x{\@s{31.61} \.{\land} BlockedThread [ c ] . type \.{=}\@w{write}}%
\@x{\@s{31.61} \.{\land} {\IF} BlockedThread [ c ] . wc \.{=}\@w{num}}%
\@y{\@s{0}%
 w:\ensuremath{num
}}%
\@xx{}%
 \@x{\@s{46.82} \.{\THEN} \.{\LET} replicatedServers \.{\defeq}
 ReplicatedServers ( State [ BlockedThread [ c ] . s ] ,\, BlockedThread [ c
 ] . ot )}%
 \@x{\@s{78.13} \.{\IN} Cardinality ( replicatedServers ) \.{\geq}
 BlockedThread [ c ] . numnode}%
 \@x{\@s{42.72} \.{\ELSE} {\lnot} HLCLt ( Cp [ BlockedThread [ c ] . s ] ,\,
 BlockedThread [ c ] . ot )}%
\@y{\@s{0}%
 w:majority
}%
\@xx{}%
 ...
 \.{=}\@s{4.1} Append ( @ ,\, [ op \.{\mapsto}\@w{put} ,\,}%
 \@x{\@s{93.93} ct \.{\mapsto} Ct [ BlockedThread [ c ] . s ] ,\, ot
 \.{\mapsto} BlockedThread [ c ] . ot ,\,}%
 \@x{\@s{93.93} k \.{\mapsto} BlockedThread [ c ] . k ,\, v \.{\mapsto}
 BlockedThread [ c ] . v ] ) ]}%
 \@x{\@s{31.61} \.{\land} BlockedThread \.{'} \.{=}\@s{4.1} [ BlockedThread
 {\EXCEPT} {\bang} [ c ] \.{=} Nil ]}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ClientGetRequest \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \E\, k \.{\in} Key ,\, c \.{\in} Client
 \.{\,\backslash\,} BlockedClient \.{:}}%
\@x{\@s{31.61} \.{\land} OpCount [ c ] \.{\neq} 0}%
\@x{\@s{31.61} \.{\land} {\IF} ReadConcern \.{=}\@w{linearizable}}%
\@y{\@s{0}%
 In this case, read can only be sent to primary
}%
\@xx{}%
\@x{\@s{42.72} \.{\THEN} \E\, s \.{\in} Primary \.{:}}%
 \@x{\@s{74.03} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ] \.{=}
 Append ( @ ,\,}%
 \@x{\@s{74.03} [ op \.{\mapsto}\@w{get} ,\, c \.{\mapsto} c ,\, rc
 \.{\mapsto} ReadConcern ,\, k \.{\mapsto} k ,\, ct \.{\mapsto} Ct [ c ] ,\,
 ot \.{\mapsto} Ot [ c ] ] ) ]}%
\@x{\@s{42.72} \.{\ELSE} {\IF} ReadPreference \.{=}\@w{primary}}%
\@y{\@s{0}%
 rp can be only primary or secondary
}%
\@xx{}%
\@x{\@s{90.28} \.{\THEN} \E\, s \.{\in} Primary \.{:}}%
 \@x{\@s{121.59} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ] \.{=}
 Append ( @ ,\,}%
 \@x{\@s{121.59} [ op \.{\mapsto}\@w{get} ,\, c \.{\mapsto} c ,\, rc
 \.{\mapsto} ReadConcern ,\, k \.{\mapsto} k ,\, ct \.{\mapsto} Ct [ c ] ,\,
 ot \.{\mapsto} Ot [ c ] ] ) ]}%
\@x{\@s{74.03} \.{\ELSE} \E\, s \.{\in} Secondary \.{:}}%
 \@x{\@s{105.34} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ] \.{=}
 Append ( @ ,\,}%
 \@x{\@s{105.34} [ op \.{\mapsto}\@w{get} ,\, c \.{\mapsto} c ,\, rc
 \.{\mapsto} ReadConcern ,\, k \.{\mapsto} k ,\, ct \.{\mapsto} Ct [ c ] ,\,
 ot \.{\mapsto} Ot [ c ] ] ) ]}%
 \@x{\@s{31.61} \.{\land} BlockedClient \.{'} \.{=} BlockedClient \.{\cup} \{
 c \}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, clientnodeVars
 ,\, BlockedThread ,\, InMsgc ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Client Put
...
\@xx{}%
\@x{ ClientPutRequest \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \E\, k \.{\in} Key ,\, v \.{\in} Value ,\, c \.{\in}
 Client \.{\,\backslash\,} BlockedClient ,\, s \.{\in} Primary \.{:}}%
\@x{\@s{31.61} \.{\land} OpCount [ c ] \.{\neq} 0}%
 \@x{\@s{31.61} \.{\land} InMsgs \.{'} \.{=} [ InMsgs {\EXCEPT} {\bang} [ s ]
 \.{=} Append ( @ ,\,}%
 \@x{\@s{101.88} [ op \.{\mapsto}\@w{put} ,\, c \.{\mapsto} c ,\, wc
 \.{\mapsto} WriteConcern ,\, num \.{\mapsto} WriteNumber ,\, k \.{\mapsto} k
 ,\, v \.{\mapsto} v ,\, ct \.{\mapsto} Ct [ c ] ] ) ]}%
\@x{\@s{31.61} \.{\land} {\IF} WriteConcern \.{=}\@w{zero}}%
\@y{%
 If w:0, decrease \ensuremath{op} count and record history
}%
\@xx{}%
 \@x{\@s{46.82} \.{\THEN} \.{\land} OpCount \.{'} \.{=} [ OpCount {\EXCEPT}
 {\bang} [ c ] \.{=} @ \.{-} 1 ]}%
 \@x{\@s{78.13} \.{\land} History \.{'}\@s{7.32} \.{=} [ History {\EXCEPT}
 {\bang} [ c ] \.{=} Append ( @ ,\, [ op \.{\mapsto}\@w{put} ,\, ts
 \.{\mapsto} Ot [ c ] ,\, k \.{\mapsto} k ,\, v \.{\mapsto} v ] ) ]}%
\@x{\@s{78.13} \.{\land} BlockedClient \.{'} \.{=} BlockedClient}%
 \@x{\@s{42.72} \.{\ELSE} \.{\land} BlockedClient \.{'} \.{=} BlockedClient
 \.{\cup} \{ c \}}%
\@y{%
 Else wait for server reply
}%
\@xx{}%
\@x{\@s{74.03} \.{\land} OpCount \.{'} \.{=} OpCount}%
\@x{\@s{74.03} \.{\land} History \.{'}\@s{7.32} \.{=} History}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, BlockedThread
 ,\, InMsgc ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 ...
 InMsgc [ c ] [ 1 ] . k ] \.{=} InMsgc [ c ] [ 1 ] . v ]\@s{4.1}}%
\@y{\@s{0}%
 store data
}%
\@xx{}%
 ...
 c ] ) \.{=} 0}%
\@x{\@s{134.98} \.{\THEN} BlockedClient \.{\,\backslash\,} \{ c \}}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, State ,\, Cp
 ,\, CurrentTerm ,\, messageVar ,\, SyncSource ,\, Oplog ,\, timeVar ,\,}%
\@x{\@s{89.98} BlockedThread ,\, InMsgs ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, Cp ,\,
 CurrentTerm ,\, State ,\, messageVar ,\, SyncSource ,\, storageVars ,\,
 timeVar ,\,}%
\@x{\@s{89.98} BlockedThread ,\, InMsgs ,\, SnapshotTable {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
\@x{ ServerGetReply \.{\defeq} \.{\lor} ServerGetReply\_sleep}%
\@x{\@s{87.19} \.{\lor} ServerGetReply\_wake}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ServerPutReply \.{\defeq} \.{\lor} ServerPutReply\_sleep}%
\@x{\@s{87.00} \.{\lor} ServerPutReply\_wake}%
\@x{}\midbar\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 16 17:05:05 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
