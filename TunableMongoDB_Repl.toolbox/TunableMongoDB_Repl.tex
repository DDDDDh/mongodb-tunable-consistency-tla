...
\@xx{}%
 \@x{\@s{133.87} \.{\THEN}\@s{4.1} AdvanceState ( ServerMsg [ s ] [ 1 ] . aot
 ,\,}%
\@x{\@s{231.96} State [ s ] [ ServerMsg [ s ] [ 1 ] . s ] ,\, CalState )}%
...
\@xx{}%
 \@x{\@s{84.05} {\IF} s \.{\in} Primary \.{\THEN} CalState \.{'} [ Cardinality
 ( Server ) \.{\div} 2 \.{+} 1 ]}%
\@x{\@s{71.75}}%
\@y{\@s{0}%
...
\@x{\@s{71.75} \.{\IN} [ Cp {\EXCEPT} {\bang} [ s ] \.{=} newcp ]}%
 ...
 ,\, s \.{\mapsto} ServerMsg [ s ] [ 1 ] . s ,\, aot \.{\mapsto} ServerMsg [
 s ] [ 1 ] . aot ,\,}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 19 22:17:02 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
