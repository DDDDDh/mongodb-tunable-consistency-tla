...
\@pvspace{8.0pt}%
 ...
 Ct ,\, Ot ,\, messageVar ,\,}%
\@x{\@s{41.61} Pt ,\, Cp ,\, State ,\, CurrentTerm ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} InitState \.{\land} InitCurrentTerm}%
...
\@x{\@s{31.61} \.{\land} Secondary \.{'} \.{=} Secondary \.{\cup} \{ s \}}%
 ...
 Ct ,\, messageVar ,\, timeVar ,\, Cp ,\, State ,\, CurrentTerm {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 messageVar ,\, timeVar ,\, Cp ,\, State {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvanceCp \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Primary \.{:}}%
...
\@xx{}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, serverVars ,\, learnableVars ,\, messageVar {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvancePt \.{\defeq}}%
\@x{\@s{16.4} \.{\land} \E\, s \.{\in} Server \.{:}}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} electionVars ,\, storageVars
 ,\, serverVars ,\, learnableVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{\@s{84.27} \.{\IN} [ State {\EXCEPT} {\bang} [ s ] \.{=} newState ]}%
 ...
 ,\, timeVar ,\, Cp ,\, CurrentTerm ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Tue} May 24
 16:55:51 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
