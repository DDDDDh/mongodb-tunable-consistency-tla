...
\@x{}%
\@y{%
 \ensuremath{{\RECURSIVE}} \ensuremath{AddState(\_,\,\_,\,\_)
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{AddState(new,\, state,\, index) \.{\defeq}
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{{\IF}} \ensuremath{index \.{=} 1 \.{\land} HLCLt(new,\, state[1])
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\THEN} {\langle}new{\rangle} \.{\circ}
 state\.{\,\backslash\,}\.{*}} less than the first
}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\ELSE} {\IF}} \ensuremath{index \.{=} Len(state) \.{+} 1
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\THEN} state \.{\circ} {\langle}new{\rangle}
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\ELSE} {\IF}} \ensuremath{HLCLt(new,\, state[index])
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\THEN} SubSeq(state,\, 1,\, index \.{-} 1) \.{\circ}
 {\langle}new{\rangle} \.{\circ} SubSeq(state,\, index,\, Len(state))
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\ELSE} AddState(new,\, state,\, index \.{+} 1)
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{%
 \ensuremath{{\RECURSIVE}} \ensuremath{RemoveState(\_,\,\_,\,\_)
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{RemoveState(old,\, state,\, index) \.{\defeq}
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{{\IF}} \ensuremath{state[index] \.{=} old
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
...
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\ELSE} RemoveState(old,\, state,\, index \.{+} 1)
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{%
 \ensuremath{AdvanceState(new,\, old,\, state) \.{\defeq} AddState(new,\,
...
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\IN} {\IF}} \ensuremath{quorums \.{=} \{\} \.{\THEN} Nil
}}%
\@xx{}%
\@x{}%
\@y{\@s{15.0}%
 \ensuremath{\.{\ELSE} {\CHOOSE} x \.{\in} quorums} : \ensuremath{{\TRUE}
}}%
\@xx{}%
\@x{}%
\@y{\@s{15.0}%
 \ensuremath{\.{\ELSE} quorums
}}%
\@xx{}%
\@x{\@s{24.59} \.{\IN} quorums}%
\@pvspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{%
 \ensuremath{InitCalState \.{\defeq} CalState \.{=}} [\ensuremath{s \.{\in}
 Server \.{\mapsto} CreateState(Cardinality(Server),\, {\langle}{\rangle})}]
}%
\@xx{}%
\@x{\@s{118.9}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ InitState \.{\defeq} State \.{=} [ s \.{\in} Server \.{\mapsto} [ s0
 \.{\in} Server \.{\mapsto}}%
 \@x{\@s{175.84} [ p \.{\mapsto} 0 ,\, l \.{\mapsto} 0 ,\, term \.{\mapsto} 0
 ] ] ]}%
...
\@x{\@s{31.61} \.{\land} ReadyToServe \.{'} \.{=} ReadyToServe \.{+} 1}%
 ...
 ,\, Oplog ,\, Store ,\, Ct ,\, Ot ,\,}%
\@x{\@s{89.98} ServerMsg ,\, Pt ,\, Cp ,\, State ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Stepdown \.{\defeq}}%
...
\@x{\@s{68.91} \.{\land} Secondary \.{'} \.{=} Secondary \.{\cup} \{ s \}}%
 ...
 ,\, ServerMsg ,\,}%
\@x{\@s{127.28} Pt ,\, Cp ,\, State ,\, CurrentTerm ,\,}%
...
\@xx{}%
 ...
 ,\, ServerMsg ,\, Pt ,\, Cp ,\, State ,\, ReadyToServe {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 \ensuremath{AdvanceCp \.{\defeq}
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} ReadyToServe \.{>} 0
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} \E\, s \.{\in} Primary}:
}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{Cp\.{'} \.{=}} [\ensuremath{Cp} \ensuremath{{\EXCEPT} {\bang}[s]
 \.{=} CalState[s][Cardinality(Server) \.{\div} 2 \.{+} 1]} ]
}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} {\UNCHANGED}{\langle}Primary,\, Secondary,\, Oplog,\,
 Store,\, Ct,\, Ot,\,
}}%
\@xx{}%
\@x{}%
\@y{\@s{42.5}%
 \ensuremath{ServerMsg}, \ensuremath{Pt}, \ensuremath{State},
 \ensuremath{CurrentTerm}, \ensuremath{ReadyToServe},
 \ensuremath{SyncSource{\rangle}
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{ AdvanceCp \.{\defeq}}%
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
\@x{\@s{16.4} \.{\land} \E\, i \.{\in} Primary \.{:}}%
 \@x{\@s{31.61} \.{\LET} quorumAgree \.{\defeq} QuorumAgreeInSameTerm ( State
 [ i ] ) \.{\IN}}%
\@x{\@s{52.01} \.{\land} quorumAgree \.{\neq} Nil}%
 \@x{\@s{52.01} \.{\land} \.{\LET} serverInQuorum \.{\defeq} {\CHOOSE} s
 \.{\in} quorumAgree \.{:} {\TRUE}}%
\@x{\@s{83.52} termOfQuorum \.{\defeq} State [ i ] [ serverInQuorum ] [ 3 ]}%
 \@x{\@s{83.52} newCommitPoint \.{\defeq} HLCMinSet ( \{ [ p \.{\mapsto} State
 [ i ] [ s ] [ 1 ] ,\, l \.{\mapsto} State [ i ] [ s ] [ 2 ] ] \.{:} s
 \.{\in} quorumAgree \} )}%
\@x{\@s{63.12} \.{\IN} \.{\land} termOfQuorum \.{=} CurrentTerm [ i ]}%
 \@x{\@s{83.52} \.{\land} \.{\LET} newCP \.{\defeq} [ p \.{\mapsto}
 newCommitPoint . p ,\, l \.{\mapsto} newCommitPoint . l ,\, term \.{\mapsto}
 termOfQuorum ] \.{\IN}}%
\@x{\@s{115.03} Cp \.{'} \.{=} [ Cp {\EXCEPT} {\bang} [ i ] \.{=} newCP ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} Primary ,\, Secondary ,\,
 Oplog ,\, Store ,\, Ct ,\, Ot ,\,}%
 \@x{\@s{90.19} ServerMsg ,\,\@s{4.1} Pt ,\, State ,\, CurrentTerm ,\,
...
\@x{}%
\@y{\@s{77.5}%
 \ensuremath{\.{\THEN} \.{\LET} serverInQuorum \.{\defeq} {\CHOOSE} i \.{\in}
 quorumAgree} : \ensuremath{{\TRUE}
}}%
\@xx{}%
\@x{}%
\@y{\@s{100.0}%
 \ensuremath{termOfQuorum \.{\defeq} State[s][serverInQuorum].term
}}%
\@xx{}%
\@x{}%
\@y{\@s{100.0}%
 \ensuremath{newCommitPoint \.{\defeq} HLCMinSet(\{[p \.{\mapsto}
 State[s][j].p,\, l \.{\mapsto} State[s][j].l]\.{:} j \.{\in} quorumAgree\})
}}%
\@xx{}%
\@x{}%
\@y{\@s{90.0}%
 \ensuremath{\.{\IN} {\IF}} \ensuremath{termOfQuorum \.{=} CurrentTerm[s]
}}%
\@xx{}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{\.{\THEN}} [\ensuremath{p \.{\mapsto} newCommitPoint.p},
 \ensuremath{l \.{\mapsto} newCommitPoint.l}, \ensuremath{term \.{\mapsto}
 termOfQuorum}]
}%
\@xx{}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{\.{\ELSE} Cp[s]
}}%
\@xx{}%
 \@x{\@s{114.8} \.{\THEN} [ p \.{\mapsto} 2 ,\, l \.{\mapsto} 2 ,\, term
 \.{\mapsto} 2 ]}%
\@x{\@s{114.8} \.{\ELSE} Cp [ s ]}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{70.0}\.{\land} quorumAgree \.{\neq}
 Nil
}}%
\@xx{}%
\@x{}%
\@y{\@s{67.5}%
 \ensuremath{\.{\land} Cardinality(quorumAgree) \.{>} 0
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{70.0}\.{\land} \.{\LET}
 serverInQuorum \.{\defeq} {\CHOOSE} i \.{\in} quorumAgree}:
 \ensuremath{{\TRUE}
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{87.5}termOfQuorum \.{\defeq}
 State[s][serverInQuorum].term
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{87.5}newCommitPoint \.{\defeq}
 HLCMinSet(\{[p \.{\mapsto} State[s][i].p,\, l \.{\mapsto}
 State[s][i].l]\.{:} i \.{\in} quorumAgree\})
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{77.5}\.{\IN} {\IF}}
 \ensuremath{termOfQuorum \.{=} CurrentTerm[s]
}}%
\@xx{}%
\@x{}%
\@y{\@s{67.5}%
 \ensuremath{\.{\land} \.{\LET} serverInQuorum \.{\defeq} {\CHOOSE} i \.{\in}
 quorumAgree}: \ensuremath{{\TRUE}
}}%
\@xx{}%
\@x{}%
...
\@x{}%
\@y{%
 \ensuremath{\.{\,\backslash\,}\.{*}\@s{90.0}\.{\THEN}} [ \ensuremath{p
 \.{\mapsto} newCommitPoint.p}, \ensuremath{l \.{\mapsto} newCommitPoint.l},
 \ensuremath{term \.{\mapsto} termOfQuorum} ]
}%
\@xx{}%
\@x{}%
\@y{\@s{87.5}%
 \ensuremath{\.{\THEN}} [\ensuremath{p \.{\mapsto} 5}, \ensuremath{l
 \.{\mapsto} 5}, \ensuremath{term \.{\mapsto} termOfQuorum}]
}%
\@xx{}%
\@x{}%
\@y{\@s{82.5}%
...
\@xx{}%
 \@x{\@s{90.09} \.{\ELSE} {\IF} \.{\LET} msgCP \.{\defeq} [ p \.{\mapsto}
 ServerMsg [ s ] [ 1 ] . cp . p ,\, l \.{\mapsto} ServerMsg [ s ] [ 1 ] . cp
 . l ] \.{\IN}}%
\@x{\@s{133.56} \.{\land} {\lnot} HLCLt ( msgCP ,\, Cp [ s ] )}%
\@x{\@s{133.56} \.{\land} {\lnot} HLCLt ( Ot [ s ] ,\, msgCP )}%
\@x{\@s{106.49} \.{\THEN} ServerMsg [ s ] [ 1 ] . cp}%
\@x{\@s{106.49} \.{\ELSE} Cp [ s ]}%
\@x{\@s{69.7} \.{\IN} [ Cp {\EXCEPT} {\bang} [ s ] \.{=} newcp ]}%
 \@x{\@s{28.7} \.{\land} ServerMsg \.{'} \.{=} [ ServerMsg {\EXCEPT} {\bang} [
 s ] \.{=} Tail ( @ ) ]}%
 \@x{\@s{28.7} \.{\land} CurrentTerm \.{'} \.{=} [ CurrentTerm {\EXCEPT}
 {\bang} [ s ] \.{=} Max ( CurrentTerm [ s ] ,\, ServerMsg [ s ] [ 1 ] . term
 ) ]}%
 \@x{\@s{16.4} \.{\land}\@s{1.18} {\UNCHANGED} {\langle} Primary ,\, Secondary
 ,\, Oplog ,\, Store ,\, Ot ,\, Pt ,\,}%
\@x{\@s{91.17} ReadyToServe ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{84.05} {\IF} s \.{\in} Primary \.{\THEN}}%
 ...
 [ s ] ) \.{\IN}}%
\@x{\@s{120.71} {\IF} Cardinality ( quorumAgree ) \.{>} 0}%
\@x{\@s{132.86} \.{\THEN} \E\, serverInQuorum \.{\in} quorumAgree \.{:}}%
 \@x{\@s{164.18} \.{\LET} termOfQuorum \.{\defeq} State [ s ] [ serverInQuorum
 ] . term}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{StateSet \.{\defeq} \{[p \.{\mapsto} State[s][j].p,\, l
 \.{\mapsto} State[s][j].l]\.{:} j \.{\in} quorumAgree\}
}}%
\@xx{}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{newCommitPoint \.{\defeq} HLCMinSet(StateSet)
}}%
\@xx{}%
 \@x{\@s{172.2} newCommitPoint \.{\defeq} [ p \.{\mapsto} State [ s ] [
 serverInQuorum ] . p ,\, l \.{\mapsto} State [ s ] [ serverInQuorum ] . l ]}%
\@x{\@s{147.59} \.{\IN} {\IF} termOfQuorum \.{=} CurrentTerm [ s ]}%
 \@x{\@s{172.09} \.{\THEN} [ p \.{\mapsto} newCommitPoint . p ,\, l
 \.{\mapsto} newCommitPoint . l ,\, term \.{\mapsto} termOfQuorum ]}%
\@x{\@s{167.99} \.{\ELSE} Cp [ s ]}%
\@x{\@s{114.8} \.{\ELSE} Cp [ s ]}%
\@x{\@s{69.7}}%
\@y{\@s{0}%
 secondary node: update mcp
...
\@x{\@s{133.56} \.{\land} {\lnot} HLCLt ( msgCP ,\, Cp [ s ] )}%
\@x{\@s{133.56} \.{\land} {\lnot} HLCLt ( Ot [ s ] ,\, msgCP )}%
\@x{\@s{121.41} \.{\THEN} ServerMsg [ s ] [ 1 ] . cp}%
\@x{\@s{121.41} \.{\ELSE} Cp [ s ]}%
\@x{\@s{69.7} \.{\IN} [ Cp {\EXCEPT} {\bang} [ s ] \.{=} newcp ]}%
 \@x{\@s{28.7} \.{\land} CurrentTerm \.{'} \.{=} [ CurrentTerm {\EXCEPT}
 {\bang} [ s ] \.{=} Max ( CurrentTerm [ s ] ,\, ServerMsg [ s ] [ 1 ] . term
 ) ]}%
 \@x{\@s{28.7} \.{\land} ServerMsg \.{'} \.{=} \.{\LET} newServerMsg
 \.{\defeq} [ ServerMsg {\EXCEPT} {\bang} [ s ] \.{=} Tail ( @ ) ]}%
 \@x{\@s{102.34} \.{\IN} ( \.{\LET}\@s{4.1} appendMsg \.{\defeq} [ type
 \.{\mapsto}\@w{update\_position} ,\, s \.{\mapsto} ServerMsg [ s ] [ 1 ] . s
 ,\, aot \.{\mapsto} ServerMsg [ s ] [ 1 ] . aot ,\,}%
 \@x{\@s{183.93} ct \.{\mapsto} ServerMsg [ s ] [ 1 ] . ct ,\, cp \.{\mapsto}
 ServerMsg [ s ] [ 1 ] . cp ,\, term \.{\mapsto} ServerMsg [ s ] [ 1 ] . term
 ]}%
 \@x{\@s{126.63} \.{\IN} ( \.{\LET} newMsg \.{\defeq} {\IF} s \.{\in} Primary
 \.{\lor} SyncSource [ s ] \.{=} Nil}%
\@x{\@s{241.87} \.{\THEN} newServerMsg}%
\@y{\@s{0}%
 If \ensuremath{s} is primary, accept the \ensuremath{msg}, else forward it
 to its sync source
}%
\@xx{}%
 \@x{\@s{225.61} \.{\ELSE} [ newServerMsg {\EXCEPT} {\bang} [ SyncSource [ s ]
 ] \.{=} Append ( newServerMsg [ SyncSource [ s ] ] ,\, appendMsg ) ]}%
\@x{\@s{150.92} \.{\IN} newMsg ) )}%
 \@x{\@s{16.4} \.{\land}\@s{1.18} {\UNCHANGED} {\langle} Primary ,\, Secondary
 ,\, Oplog ,\, Store ,\, Ot ,\,}%
\@x{\@s{91.17} Pt ,\, ReadyToServe ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NTPSync \.{\defeq}}%
\@y{\@s{0}%
...
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} Primary ,\, Secondary ,\,
 Oplog ,\, Store ,\, Ct ,\, Ot ,\,}%
 \@x{\@s{90.19} ServerMsg ,\, Cp ,\, State ,\, CurrentTerm ,\, ReadyToServe
 ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvancePt \.{\defeq}}%
\@x{\@s{16.4} \.{\land} ReadyToServe \.{>} 0}%
...
\@x{\@s{89.98} Cp ,\, CurrentTerm ,\, ReadyToServe ,\, SyncSource {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} CalState\.{'} \.{=}} [\ensuremath{CalState}
 \ensuremath{{\EXCEPT} {\bang}[i] \.{=} CalState[j]}]
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} Primary ,\, Secondary ,\, Pt
 ,\, ReadyToServe {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 29 14:33:41 \ensuremath{CST} 2022 by \ensuremath{dh
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
